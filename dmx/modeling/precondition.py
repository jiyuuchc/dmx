...
def edm_precond(model, x, sigma, x_cond=None, **kwargs):
    dtype = model.module.dtype or jnp.float32
...
class EdmPrecond(nnx.Module):
    ...
    KeywardArgs:
        return_val: "x":" D(x) "e": e(x) = (x - D(x)) / sigma
    ...
    def __call__(self, x, sigma, x_cond=None, *, return_val:str="x", **kwargs):
